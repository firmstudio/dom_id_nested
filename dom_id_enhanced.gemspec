...
require_relative "lib/dom_id_enhanced/version"

Gem::Specification.new do |spec|
  spec.name = "dom_id_enhanced"
  spec.version = DomIdEnhanced::VERSION
  spec.authors = ["Eddie Rodriguez"]
  spec.email = ["8533760+nwoeddie@users.noreply.github.com"]

  spec.summary = "Enhanced DOM ID helper for Ruby on Rails"
  ...
  spec.homepage = "https://github.com/firmstudio/dom_id_enhanced"
  spec.license = "MIT"
